...
nim_ruleset: Ruleset = Ruleset(nim_rules)
...
tic_tac_toe_rules: Sequence[Sentence] = (
    # Role
...
tic_tac_toe_ruleset: Ruleset = Ruleset(tic_tac_toe_rules)
...
rock_paper_scissors_rules: Sequence[Sentence] = (
    # Role
    Sentence.fact(
...
rock_paper_scissors_ruleset: Ruleset = Ruleset(rock_paper_scissors_rules)

_X = Variable("X")
__C = Variable("_C")
_Everyone = Variable("Everyone")

minipoker_rules: Sequence[Sentence] = (
    # Role
    Sentence.fact(
...
minipoker_ruleset: Ruleset = Ruleset(minipoker_rules)
